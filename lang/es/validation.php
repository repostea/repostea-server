...
return [
    ...
    */
    ...
    // Sub validation
    'sub' => [
        'name_required' => 'El nombre de la subcomunidad es obligatorio.',
        'name_unique' => 'Ya existe una subcomunidad con ese nombre.',
        'name_alpha_dash' => 'El nombre solo puede contener letras, números, guiones y guiones bajos.',
        'name_min' => 'El nombre debe tener al menos 3 caracteres.',
        'name_max' => 'El nombre no puede superar los 50 caracteres.',
        'display_name_required' => 'El nombre a mostrar es obligatorio.',
        'display_name_min' => 'El nombre a mostrar debe tener al menos 3 caracteres.',
        'display_name_max' => 'El nombre a mostrar no puede superar los 100 caracteres.',
        'description_max' => 'La descripción no puede superar los 500 caracteres.',
        'rules_max' => 'Las reglas no pueden superar los 2000 caracteres.',
        'color_regex' => 'El color debe ser un código hexadecimal válido (ej: #3B82F6).',
        'visibility_in' => 'La visibilidad debe ser: visible, hidden o private.',
        'limit_reached' => 'Has alcanzado el límite de %d subcomunidad(es) para tu nivel. Sube de nivel para crear más.',
    ],
    ...
    'post' => [
        ...
        'title_max' => 'El título no puede exceder :max caracteres',
        'url_invalid' => 'La URL no es válida',
        'url_required' => 'La URL es obligatoria para este tipo de contenido',
        'content_required' => 'El contenido es obligatorio para publicaciones de texto',
        'category_required' => 'Debes seleccionar una categoría',
        'category_exists' => 'La categoría seleccionada no existe',
        'content_type_in' => 'El tipo de contenido debe ser enlace, texto, vídeo, audio, imagen o encuesta',
    ],
];
