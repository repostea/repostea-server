...
return new class() extends Migration
{
    ...
    {
        // Ensure legal_reports table exists first (dependency)
        ...
        if (Schema::hasTable('legal_report_notes')) {
            return;
        }

        Schema::create('legal_report_notes', function (Blueprint $table): void {
            $table->id();
    ...
    {
        Schema::dropIfExists('legal_report_notes');
    }
};
